...
def faces_align(landmarkModel, target_image_path, verify_image_path, image_size=224):
    aligned_imgs =[]
    ...
    for path in img_list:
        ...
        bboxes, landmarks = landmarkModel.gets(target_img,verify_img)
...
if __name__ == '__main__':
    ...
    if args.need_align:
        ...
        bboxes, target_aligned_images = faces_align(landmarkModel, args.target_img_path, args.verify_img_path, args.image_size)
