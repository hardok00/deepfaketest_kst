...
def target_faces_align(landmarkModel, target_image_path, image_size=224):
    aligned_imgs =[]
...
if __name__ == '__main__':
    ...
    if args.need_align:
        ...
        bboxes, target_aligned_images = target_faces_align(landmarkModel, args.target_img_path, args.image_size)
